...
export function HomeIntroduction() {
  ...
  return (
    <div className="w-full max-w-[30rem] px-8 min-[761px]:translate-x-11 max-[560px]:px-6">
      <h1 className="mb-6 font-[family-name:var(--font-geist)] text-[2.75rem] leading-none font-normal tracking-[-0.035em] text-[#10110f] dark:text-[#f0f0e9]">
        Kurt Xiao
      </h1>
      <p className="max-w-[26rem] text-base leading-6 text-[#555650] dark:text-[#a8aaa2]">
